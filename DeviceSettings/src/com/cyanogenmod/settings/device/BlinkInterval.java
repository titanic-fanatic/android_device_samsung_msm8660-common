...
public class BlinkInterval extends DialogPreference {
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            if (callChangeListener(valueOnOff)) {
                setValue(valueOnOff);
                Utils.writeValue(FILE_BLN_INTERVAL, this.mValueOnOff + "\n");
                Utils.showDialog(mContext, "Interval Set", "Blink interval set successfully!");
            }
        }
    }
