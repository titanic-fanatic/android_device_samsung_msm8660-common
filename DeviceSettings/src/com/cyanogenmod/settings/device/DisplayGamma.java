...
public class DisplayGamma extends DialogPreference {
    ...
    public static void setGamma(int control, String gamma) {
    ...
    public DisplayGamma(Context context, AttributeSet attrs) {
        ...
        mNumberOfControls = getNumberOfControls();
    ...
    protected void onBindDialogView(View view) {
        ...
        for (int index = 0; index < mNumberOfControls; index++) {
            mOriginalColors[index] = getCurGamma(index);
            ...
            for (int color = 0; color < BAR_COLORS.length; color++) {
                ...
                mSeekBars[index][color].setSeekGamma(Integer.valueOf(mCurrentColors[index][color]));
        ...
        defaultsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                for (int index = 0; index < mSeekBars.length; index++) {
                    ...
                    for (int color = 0; color < BAR_COLORS.length; color++) {
                        mSeekBars[index][color].setSeekGamma(Integer.valueOf(defaultColors[color]));
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            for (int i = 0; i < mNumberOfControls; i++) {
                editor.putString("display_gamma_" + i, getCurGamma(i));
            }
            editor.commit();
        } else if (mOriginalColors != null) {
            for (int i = 0; i < mNumberOfControls; i++) {
                setGamma(i, mOriginalColors[i]);
            }
        }
    }
    ...
    private class GammaSeekBar implements SeekBar.OnSeekBarChangeListener {
        ...
        public GammaSeekBar(int controlIndex, int colorIndex, ViewGroup container) {
            ...
            mSeekBar.setMax(getMaxValue(controlIndex) - mMin);
        ...
        public void setSeekGamma(int gamma) {
